...
const RoadmapTimeline = () => {
  ...
  return (
    <section className="bg-white overflow-x-hidden">
      {/* 1. HERO SECTION - Fixed scale for mobile */}
      ...
      {/* 2. CORE INFO SECTION - Stacked on mobile */}
      ...
      {/* 3. MILESTONES - Fixed for Mobile consistency */}
      <div className="bg-gray-950 py-24">
        ...
        <div className="max-w-5xl mx-auto relative px-6">
          {/* Vertical Spine - Adjusted for mobile */}
          ...
          <div className="space-y-12 md:space-y-24">
            {timelineData.map((step, index) => (
              ...
              >
                {/* Connector Dot - Aligned left on mobile */}

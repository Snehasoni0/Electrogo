...
const InfraHero = () => {
  return (
    <section className="relative h-screen w-full overflow-hidden flex items-center justify-center bg-[#0d1117]">
      ...
      {/* 1. INFRASTRUCTURE VISUAL WITH DARK PROTOCOL OVERLAY */}
      ...
      {/* 2. CENTRAL COMMAND HUB */}
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">

        {/* H1: Infrastructure Headline */}
        <motion.h1 
        ...
        {/* Sub-text: Dense Network Connectivity */}
        <motion.p 
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      <motion.div 
        ...
        className="absolute bottom-10 left-1/2 -translate-x-1/2 z-10 flex flex-col items-center gap-3 opacity-30"
      >
        <span className="font-mono text-[9px] text-white uppercase tracking-[0.4em]">Infrastructure Grid</span>
